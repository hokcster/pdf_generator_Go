...
func main() {
	...
	pdf.ImageOptions("motorcycle.png", 60, 100, 90, 0, false, gofpdf.ImageOptions{ImageType: "PNG", ReadDpi: true}, 0, "")
	...
	for _, header := range headers {
		pdf.CellFormat(50, 20, header, "1", 0, "", false, 0, "")
	}
	...
	for _, line := range data {
		for _, cell := range line {
			pdf.CellFormat(50, 20, cell, "1", 0, "", false, 0, "")
		}
		pdf.Ln(-1)
	}
